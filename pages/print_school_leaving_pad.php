...
<head>
    ...
    <title>School Leaving Certificate (PAD)</title>
    ...
    <style>
        * {
        ...
        /* A4 page wrapper — no top padding, all spacing controlled by spacers */
        .cert-page {
            width: 210mm;
            height: 297mm;
            max-height: 297mm;
        ...
        /* 2.5 inch blank space above the title (1 inch = 25.4mm) */
        .top-spacer {
            height: 43.5mm;
            flex-shrink: 0;
        }

        /* 1.5 inch blank space below signatures */
        .bottom-spacer {
            height: 28.1mm;
            flex-shrink: 0;
        }
        ...
        /* Main content area — side padding only */
        .content {
            position: relative;
            z-index: 10;
            flex: 1;
    ...
    <script>
        ...
        document.getElementById('downloadPdfBtn').addEventListener('click', function () {
            ...
            if (totalCerts === 1) {
                ...
                filename = `Name: ${studentName} , GR: ${grNo} , Year: ${passingYear} , SLC(PAD).pdf`;
            } else {
                const year = new URLSearchParams(window.location.search).get('year') || 'Bulk';
                filename = `School_Leaving_Certificates_PAD_${year}.pdf`;
            }
    ...
    <div id="certificates-wrapper">
        <?php foreach ($studentsToPrint as $index => $student):
            ...
            <div class="cert-page <?php echo ($index < count($studentsToPrint) - 1) ? 'page-break' : ''; ?>"
                ...
                <!-- 2.5 inch blank space above title -->
                        ...
                        <div class="fields-body">
                            ...
                            <div class="field-row">
                                ...
                                <div class="field-value">
                                    <?php echo htmlspecialchars(preg_replace('/[^0-9]/', '', $student['gr_no'])); ?>
                                </div>
                            </div>
                            ...
                            <div class="field-row">
                                ...
                                <div class="field-value">
                                    <?php echo !empty($student['date_of_birth']) ? date('d-m-Y', strtotime($student['date_of_birth'])) : ''; ?>
                                </div>
                            </div>
                            ...
                            <div class="field-row">
                                ...
                                <div class="field-value">
                                    <?php echo htmlspecialchars($student['place_of_birth'] ?? 'Tando Allahyar'); ?>
                                </div>
                            </div>
                            ...
                            <div class="field-row">
                                ...
                                <div class="field-value">
                                    <?php echo htmlspecialchars(!empty(trim($student['previous_school'] ?? '')) ? $student['previous_school'] : 'New'); ?>
                                </div>
                            </div>
                            ...
                            <div class="field-split">
                                <div class="field-row">
                                    ...
                                    <div class="field-value">
                                        <?php echo !empty($student['admission_date']) ? date('d-m-Y', strtotime($student['admission_date'])) : ''; ?>
                                    </div>
                                </div>
                                <div class="field-row">
                                    <span class="field-label">Class at Admission</span>
                                    <div class="field-value">
                                        <?php echo htmlspecialchars($student['admission_class'] ?? 'KG'); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="field-row">
                                ...
                                <div class="field-value">
                                    <?php echo !empty($_GET['leaving_date']) ? date('d-m-Y', strtotime($_GET['leaving_date'])) : (!empty($student['updated_at']) ? date('d-m-Y', strtotime($student['updated_at'])) : date('d-m-Y')); ?>
                                </div>
                            </div>

                            <?php $leavingClass = !empty($_GET['leaving_class']) ? $_GET['leaving_class'] : ($student['last_class'] ?? $student['current_class']); ?>
